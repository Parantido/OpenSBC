...
<div class="customers-form">
    ...
    echo DetailView::widget([
        ...
        'attributes' => [
            'firstname'=>['attribute'=>'firstname', 'type'=> Form::INPUT_TEXT],
            'lastname'=>['attribute'=>'lastname', 'type'=> Form::INPUT_TEXT],
            'status'=>['attribute'=>'status', 'type'=> Form::INPUT_DROPDOWN_LIST],
            'domain_id'=>['attribute'=>'domain_id', 'type'=> Form::INPUT_DROPDOWN_LIST],
            'address1'=>['attribute'=>'address1', 'type'=> Form::INPUT_TEXT],
            'address2'=>['attribute'=>'address2', 'type'=> Form::INPUT_TEXT],
            'state'=>['attribute'=>'state', 'type'=> Form::INPUT_DROPDOWN_LIST],
            'city'=>['attribute'=>'city', 'type'=> Form::INPUT_WIDGET],
            'country'=>['attribute'=>'country', 'type'=> Form::INPUT_TEXT],
            'province'=>['attribute'=>'province', 'type'=> Form::INPUT_TEXT],
            'zip'=>['attribute'=>'zip', 'type'=> Form::INPUT_TEXT],
            'location'=>['attribute'=>'location', 'type'=> Form::INPUT_TEXT],
            'phone1'=>['attribute'=>'phone1', 'type'=> Form::INPUT_TEXT],
            'ptype1'=>['attribute'=>'ptype1', 'type'=> Form::INPUT_DROPDOWN_LIST],
            'phone2'=>['attribute'=>'phone2', 'type'=> Form::INPUT_TEXT],
            'ptype2'=>['attribute'=>'ptype2', 'type'=> Form::INPUT_DROPDOWN_LIST],
            'phone3'=>['attribute'=>'phone3', 'type'=> Form::INPUT_TEXT],
            'ptype3'=>['attribute'=>'ptype3', 'type'=> Form::INPUT_DROPDOWN_LIST],
            'email'=>['attribute'=>'email', 'type'=> Form::INPUT_TEXT],
            'username'=>['attribute'=>'username', 'type'=> Form::INPUT_TEXT],
            'password'=>['attribute'=>'password', 'type'=> Form::INPUT_PASSWORD],
            'skypeid'=>['attribute'=>'skypeid', 'type'=> Form::INPUT_TEXT],
            'notes'=>['attribute'=>'notes', 'type'=> Form::INPUT_TEXTAREA],
        ]
    ]);
